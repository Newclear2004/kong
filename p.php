                    ...
                    <div class="col-md-6">
                            <div class="a"><br>
                                <table width="40%" align="center">
                                    <tr>
                                        <td align="center"><a href="post.php" class="btn btn-dark">สร้างโพสต์</a></td>
                                    </tr>
                                </table><br>
                            </div><br>
                        <?php $_SESSION['idp']=""; ?>
                        <?php
                            $re=mysqli_query($conn,"SELECT * FROM  post WHERE id='".$_SESSION['id']."'  ORDER BY idp desc ");
                        ...
                        ?>          
                                    <tr>
                                        <td ><img src="pic/<?php echo $datan['pic'] ?>" class="rounded-circle me-2" width="30" height="30"> <?php echo $datan['name'] ?></td>
                                        <td align="right"><a href="epost.php?idp=<?php echo $data['idp'] ?>"><font color="blue">แก้ไข</font></a> <a href="de.php?idp=<?php echo $data['idp'] ?>"><font color="red">ลบ</font></a></td>
                                    </tr>
                        <?php } ?>
                                    <tr>
