                    ...
                    <div class="col-md-9">
                        <div class="a"><br>
                            <table width="80%" align="center">
                                ...
                                <tr>
                                    <td><input type="text" name="nameq" class="form-control" required></td>
                                    <td><input type="submit" name="aq" value="เพิ่ม..." class="btn btn-dark"></td>
                                </tr>
                                </form>
                            </table><br>
                        </div><br>
                            ...
                            <tr>
                                <td>
                                    <div class="a"><br>
                                        <table align="center">
                                            <tr>
                                                <td><a href="afr.php" class="btn btn-dark">รายงานสรุปผลแบบประเมิน</a></td>
                                            </tr>
                                        </table><br>
                                    </div>
                                </td>
