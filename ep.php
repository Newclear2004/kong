                    ...
                    <div class="col-md-6">
                        <div class="a">
                            <table width="60%" align="center">
                                <tr>
                                    <td align="center"><h3>เปลี่ยนรูปภาพประจำตัว</h3></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="center"><input type="file" name="pic" class="form-control" required></td>
                                </tr>
                                <tr>
                                    <td><br></td>
                                </tr>
                                <tr>
                                    <td><input type="submit" name="aep" value="เปลี่ยนรูปภาพประจำตัว" class="btn btn-dark"></td>
                                </tr>
                                <tr>
                                    <td><br></td>
                                </tr>
