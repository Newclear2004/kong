                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="a">
                            ...
                            <table class="table">
                                <tr>
                                    <td colspan="2" align="center"><h3><b>แบบประเมิน</b></h3></td>
                                </tr>
                                <?php           $i=0;
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <input type="radio" name="ans<?php echo $data['idq'] ?>" value="5" required> มากที่สุด <br>
                                        <input type="radio" name="ans<?php echo $data['idq'] ?>" value="4" required> มาก <br>
                                        <input type="radio" name="ans<?php echo $data['idq'] ?>" value="3" required> ปานกลาง <br>
                                        <input type="radio" name="ans<?php echo $data['idq'] ?>" value="2" required> น้อย <br>
                                        <input type="radio" name="ans<?php echo $data['idq'] ?>" value="1" required> น้อยที่สุด <br>
                                    </td>
                                </tr>
                                <?php } ?>
                                <tr>
                                    <td colspan="2"><input type="submit" name="form" class="btn btn-dark" value="บันทึก"></td>
                                </tr>
                            </table>
                            </form>
                        </div>
