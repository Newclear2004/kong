                    ...
                    <div class="col-md-9">
                        ...
                        <div class="a"><br>
                            <table width="80%" align="center">
                                ...
                                <form action="asearch.php" method="GET  1">
                                <tr>
                            ...
                            <tr>
                                <td>
                                    <div class="a"><br>
                                        <table align="center">
                                            <tr>
                                                <td><a href="amp.php" class="btn btn-dark">พิมพ์รายงานสมาชิก</a></td>
                                            </tr>
                                        </table><br>
                                    </div>
                                </td>
                        ...
                        <div class="a">
                            <table class="table table-hover">
                                ...
                                <?php   $i=0;
                                        $re=mysqli_query($conn,"SELECT * FROM  member WHERE status!='2' ORDER BY id  ");
