...
<head>
    ...
    <title>จัดการข้อมูลห้องสนทนา</title>
                    ...
                    <div class="col-md-9">
                        <div class="a"><br>
                            <table width="80%" align="center">
                                ...
                                <?php  
                                        $re=mysqli_query($conn,"SELECT * FROM room WHERE idr='".$_GET['idr']."' ");
                                        while($data=(mysqli_fetch_assoc($re))){
                                ?>
                                <tr><input type="hidden" name="idr" value="<?php echo $_GET['idr'] ?>">
                                    <td><input type="text" name="namer" value="<?php echo $data['namer'] ?>" class="form-control" required></td>
                                    <td><input type="submit" name="aer" value="แก้ไข..." class="btn btn-dark"></td>
                                </tr>
                                <?php } ?>
                                </form>
                            </table><br>
                        ...
                        <div class="a">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td><?php echo $i ?></td>
                                    <td><?php echo $data['namer'] ?></td>
                                    <td><a href="aer.php?idr=<?php echo $data['idr'] ?>" class="btn btn-warning">แก้ไข</a> <a href="de.php?idr=<?php echo $data['idr'] ?>" class="btn btn-danger">ลบ</a> </td>
                                </tr>
                                <?php } ?>
                            </table>
                        </div>
